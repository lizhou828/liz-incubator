...
/**
 * JDK提供的动态代理类:只需要一个代理类，而不是针对每个类编写代理类
...
//        Proxy.newProxyInstance()中的三个参数详解：
    ...
    /**
     *  当用户调用对象中的每个方法时，都通过下面的方法执行，方法必须在接口中
     * @param proxy 被代理后的对象
     * @param method 将要被（通过反射）执行的方法
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        System.out.println("方法调用完毕，耗时：" + span + "毫秒");
        return result;
    }
}
