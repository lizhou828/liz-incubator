...
//	String validateString;
	...
	public String getColumnName() {
		return StringHelper.camelStyleUpperCase(StringHelper.toUnderscoreName(getSqlName()));
	}
	...
	public String getColumnNameUpper() {
		return getColumnNameFirstUpper();
	}
	...
	public boolean getIsIdOrVersionField() {
		return isPk();
	}
...
//		}
	...
	/**
	 * Get java type with  Fully Qualified Name
	 * i.e.
			java.lang.String
			java.sql.Timestamp
			java.lang.Integer
	...
	/**
	 * Get column's type of table  in database
	 * @return
     */
